...
HueBlocks-gtnh then uses Minecraft's, and supported mod's; block textures to generate the gradient.</br>
<br><b><i>Not every single texture is included!</i></b><br>
...
The project you see now is the best I can do with my no programming skills. Don't expect something polished, use it as is with the foreknowledge that it's not perfect.
